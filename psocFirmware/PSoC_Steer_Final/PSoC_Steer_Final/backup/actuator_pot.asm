...
;  Global Symbols
;-----------------------------------------------
export  Actuator_Pot_Start
export _Actuator_Pot_Start
export  Actuator_Pot_SetPower
export _Actuator_Pot_SetPower

export  Actuator_Pot_SetGain
export _Actuator_Pot_SetGain

export  Actuator_Pot_Stop
export _Actuator_Pot_Stop

IF (Actuator_Pot_AGNDBUFAPI)
export  Actuator_Pot_EnableAGNDBuffer
export _Actuator_Pot_EnableAGNDBuffer
export  Actuator_Pot_DisableAGNDBuffer
export _Actuator_Pot_DisableAGNDBuffer
ENDIF
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Actuator_Pot_Start
;  FUNCTION NAME: Actuator_Pot_SetPower
;
;  DESCRIPTION:
...
;
 Actuator_Pot_Start:
_Actuator_Pot_Start:
 Actuator_Pot_SetPower:
_Actuator_Pot_SetPower:
...
;
   ...
   mov  A, reg[Actuator_Pot_GAIN_CR2]                      ; read power value
   and  A, ~POWERMASK                                ; clear power bits in A
   or   A, [X]                                       ; combine power value with balance of reg.
   mov  reg[Actuator_Pot_GAIN_CR2], A                 ; move complete value back to register
   pop  A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Actuator_Pot_SetGain
;
;  DESCRIPTION:
...
;    functions.
;
 Actuator_Pot_SetGain:
_Actuator_Pot_SetGain:
...
;
   ...
   mov  A, reg[Actuator_Pot_GAIN_CR0]                      ; read mux settings
   and  A, ~GAINREGMASK                                   ; clear gain bits in A
   tst  [X],HIGHGAIN                                      ; See if High Gain is set
   jnz  .SETHIGHGAIN
   and  reg[Actuator_Pot_GAIN_CR3],~EXGAIN                 ; Clear High Gain bit.
   or   A, [X]                                            ; combine gain value with balance of reg.
   mov  reg[Actuator_Pot_GAIN_CR0], A                      ; move complete value back to register
   pop  A
   RAM_EPILOGUE RAM_USE_CLASS_2
   ret
...
.SETHIGHGAIN:
   ...
   or   A, [X]                                            ; combine gain value with balance of reg.
   mov  reg[Actuator_Pot_GAIN_CR0], A                      ; move complete value back to register
   or   reg[Actuator_Pot_GAIN_CR3], EXGAIN                 ; Set High Gain bit.
   pop  A
   RAM_EPILOGUE RAM_USE_CLASS_2
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Actuator_Pot_Stop
;
;  DESCRIPTION:
...
_Actuator_Pot_Stop:
   ...
   and REG[Actuator_Pot_GAIN_CR2], ~POWERMASK
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Actuator_Pot_EnableAGNDBuffer
;
;  DESCRIPTION:
...
;    functions.
;
 Actuator_Pot_EnableAGNDBuffer:
_Actuator_Pot_EnableAGNDBuffer:
   RAM_PROLOGUE RAM_USE_CLASS_1
   and   reg[Actuator_Pot_GAIN_CR3], ~AGNDBUFMASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Actuator_Pot_DisableAGNDBuffer
;
;  DESCRIPTION:
...
;    functions.
;
 Actuator_Pot_DisableAGNDBuffer:
_Actuator_Pot_DisableAGNDBuffer:
   RAM_PROLOGUE RAM_USE_CLASS_1
   or    reg[Actuator_Pot_GAIN_CR3], AGNDBUFMASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
ENDIF

; End of File Actuator_Pot.asm
