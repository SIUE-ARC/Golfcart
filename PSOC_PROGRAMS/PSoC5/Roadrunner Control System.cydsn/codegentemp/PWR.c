...
*
* \funcusage
*  \snippet PWR_SUT.c usage_PWR_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet PWR_SUT.c usage_PWR_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet PWR_SUT.c usage_PWR_Read  
*******************************************************************************/
uint8 PWR_Read(void)
{
...
* preferred PWR_Read() API because the 
* PWR_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet PWR_SUT.c usage_PWR_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: PWR_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use PWR_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - PWR_0_INTR       (First pin in the list)
    *  - PWR_1_INTR       (Second pin in the list)
    *  - ...
    *  - PWR_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet PWR_SUT.c usage_PWR_SetInterruptMode
    *******************************************************************************/
    void PWR_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & PWR_0_INTR) != 0u) 
		{ 
			 PWR_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet PWR_SUT.c usage_PWR_ClearInterrupt
    *******************************************************************************/
