...
// QuadDec_v3_0(Counter8bit=false, CounterResolution=4, CounterSize=16, CounterSizeReplacementString=int16, CounterSizeReplacementStringUnsigned=uint16, TypeCastReplacementString=int32, UsingGlitchFiltering=true, UsingIndexInput=false, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=QuadDec_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=QuadDecSteer, CY_INSTANCE_SHORT_NAME=QuadDecSteer, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=QuadDecSteer, )
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=1, CompareMode=0, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=32768, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=32768, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=32768, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=16, RunMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=Counter_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=QuadDecDrive:Cnt16, CY_INSTANCE_SHORT_NAME=Cnt16, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=QuadDecDrive_Cnt16, )
...
// QuadDec_v3_0(Counter8bit=false, CounterResolution=4, CounterSize=16, CounterSizeReplacementString=int16, CounterSizeReplacementStringUnsigned=uint16, TypeCastReplacementString=int32, UsingGlitchFiltering=true, UsingIndexInput=false, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=QuadDec_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=QuadDecDrive, CY_INSTANCE_SHORT_NAME=QuadDecDrive, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=QuadDecDrive, )
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=25, Strobe_Mode=1, VDAC_Range=4, VDAC_Speed=2, Voltage=100, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=DVDAC:VDAC8, CY_INSTANCE_SHORT_NAME=VDAC8, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=DVDAC_VDAC8, )
...
// DVDAC_v2_10(DAC_Range=4, Initial_Value=0, InternalClock=true, InternalClockFreqHz=250000, Resolution=12, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=DVDAC_v2_10, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=DVDAC, CY_INSTANCE_SHORT_NAME=DVDAC, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=DVDAC, )
...
module top ;
    ...
    QuadDec_v3_0_1 QuadDecSteer (
        .quad_A(Net_21),
        .quad_B(Net_22),
        .index(1'b0),
        .clock(Net_29),
        .interrupt(Net_25));
    defparam QuadDecSteer.CounterResolution = 4;
    defparam QuadDecSteer.UsingGlitchFiltering = 1;
    defparam QuadDecSteer.UsingIndexInput = 0;

    QuadDec_v3_0_3 QuadDecDrive (
        .quad_A(Net_26),
        .quad_B(Net_27),
        .index(1'b0),
        .clock(Net_29),
        .interrupt(Net_30));
    defparam QuadDecDrive.CounterResolution = 4;
    defparam QuadDecDrive.UsingGlitchFiltering = 1;
    defparam QuadDecDrive.UsingIndexInput = 0;
	...
	wire [0:0] tmpOE__SENCA_net;
	wire [0:0] tmpIO_0__SENCA_net;
	wire [0:0] tmpINTERRUPT_0__SENCA_net;
	electrical [0:0] tmpSIOVREF__SENCA_net;
	...
	cy_psoc3_pins_v1_10
		...
		SENCA
		 (.oe(tmpOE__SENCA_net),
		  .y({1'b0}),
		  .fb({Net_21}),
		  .io({tmpIO_0__SENCA_net[0:0]}),
		  .siovref(tmpSIOVREF__SENCA_net),
		  .interrupt({tmpINTERRUPT_0__SENCA_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SENCA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SENCB_net;
	wire [0:0] tmpIO_0__SENCB_net;
	wire [0:0] tmpINTERRUPT_0__SENCB_net;
	electrical [0:0] tmpSIOVREF__SENCB_net;

	cy_psoc3_pins_v1_10
		#(.id("4c793e7f-06fd-4659-ae0a-09c9d4c8ccfc"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		SENCB
		 (.oe(tmpOE__SENCB_net),
		  .y({1'b0}),
		  .fb({Net_22}),
		  .io({tmpIO_0__SENCB_net[0:0]}),
		  .siovref(tmpSIOVREF__SENCB_net),
		  .interrupt({tmpINTERRUPT_0__SENCB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SENCB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DENCA_net;
	wire [0:0] tmpIO_0__DENCA_net;
	wire [0:0] tmpINTERRUPT_0__DENCA_net;
	electrical [0:0] tmpSIOVREF__DENCA_net;

	cy_psoc3_pins_v1_10
		#(.id("c2ef577d-cb00-47fb-b3bf-933bcbee3c9f"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		DENCA
		 (.oe(tmpOE__DENCA_net),
		  .y({1'b0}),
		  .fb({Net_26}),
		  .io({tmpIO_0__DENCA_net[0:0]}),
		  .siovref(tmpSIOVREF__DENCA_net),
		  .interrupt({tmpINTERRUPT_0__DENCA_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DENCA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DENCB_net;
	wire [0:0] tmpIO_0__DENCB_net;
	wire [0:0] tmpINTERRUPT_0__DENCB_net;
	electrical [0:0] tmpSIOVREF__DENCB_net;

	cy_psoc3_pins_v1_10
		#(.id("adacf3eb-a612-4652-a375-58ba6b437a43"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		DENCB
		 (.oe(tmpOE__DENCB_net),
		  .y({1'b0}),
		  .fb({Net_27}),
		  .io({tmpIO_0__DENCB_net[0:0]}),
		  .siovref(tmpSIOVREF__DENCB_net),
		  .interrupt({tmpINTERRUPT_0__DENCB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DENCB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__DVDACOUT_net;
	wire [0:0] tmpFB_0__DVDACOUT_net;
	wire [0:0] tmpIO_0__DVDACOUT_net;
	wire [0:0] tmpINTERRUPT_0__DVDACOUT_net;
	electrical [0:0] tmpSIOVREF__DVDACOUT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		DVDACOUT
		 (.oe(tmpOE__DVDACOUT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DVDACOUT_net[0:0]}),
		  .analog({Net_155}),
		  .io({tmpIO_0__DVDACOUT_net[0:0]}),
		  .siovref(tmpSIOVREF__DVDACOUT_net),
		  .interrupt({tmpINTERRUPT_0__DVDACOUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DVDACOUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    cy_annotation_universal_v1_0 C0 (
        .connect({
            Net_194,
            Net_195
        })
    );
    defparam C0.comp_name = "Capacitor_v1_0";
    defparam C0.port_names = "T1, T2";
    defparam C0.width = 2;
	...
	wire [0:0] tmpOE__STEERPOT_net;
	wire [0:0] tmpFB_0__STEERPOT_net;
	wire [0:0] tmpIO_0__STEERPOT_net;
	wire [0:0] tmpINTERRUPT_0__STEERPOT_net;
	electrical [0:0] tmpSIOVREF__STEERPOT_net;

	cy_psoc3_pins_v1_10
		#(.id("89f1aec8-c8d8-4c84-8d1f-6796f0091c4b"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	assign tmpOE__STEERPOT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BRAKEPOT_net;
	wire [0:0] tmpFB_0__BRAKEPOT_net;
	wire [0:0] tmpIO_0__BRAKEPOT_net;
	wire [0:0] tmpINTERRUPT_0__BRAKEPOT_net;
	electrical [0:0] tmpSIOVREF__BRAKEPOT_net;

	cy_psoc3_pins_v1_10
		#(.id("175cd878-2270-45a7-8a61-6ac4c274147e"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	assign tmpOE__BRAKEPOT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__RLY_REVERSE_net;
	wire [0:0] tmpFB_0__RLY_REVERSE_net;
	wire [0:0] tmpIO_0__RLY_REVERSE_net;
	wire [0:0] tmpINTERRUPT_0__RLY_REVERSE_net;
	electrical [0:0] tmpSIOVREF__RLY_REVERSE_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		RLY_REVERSE
		 (.oe(tmpOE__RLY_REVERSE_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RLY_REVERSE_net[0:0]}),
		  .io({tmpIO_0__RLY_REVERSE_net[0:0]}),
		  .siovref(tmpSIOVREF__RLY_REVERSE_net),
		  .interrupt({tmpINTERRUPT_0__RLY_REVERSE_net[0:0]}),
		  .annotation({Net_752}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__RLY_REVERSE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__RLY_COAST_net;
	wire [0:0] tmpFB_0__RLY_COAST_net;
	wire [0:0] tmpIO_0__RLY_COAST_net;
	wire [0:0] tmpINTERRUPT_0__RLY_COAST_net;
	electrical [0:0] tmpSIOVREF__RLY_COAST_net;

	cy_psoc3_pins_v1_10
		#(.id("70058678-a77f-43c3-96ef-b0647e69e6cc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		RLY_COAST
		 (.oe(tmpOE__RLY_COAST_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RLY_COAST_net[0:0]}),
		  .io({tmpIO_0__RLY_COAST_net[0:0]}),
		  .siovref(tmpSIOVREF__RLY_COAST_net),
		  .interrupt({tmpINTERRUPT_0__RLY_COAST_net[0:0]}),
		  .annotation({Net_656}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__RLY_COAST_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ESTOP_net;
	wire [0:0] tmpFB_0__ESTOP_net;
	wire [0:0] tmpIO_0__ESTOP_net;
	wire [0:0] tmpINTERRUPT_0__ESTOP_net;
	electrical [0:0] tmpSIOVREF__ESTOP_net;

	cy_psoc3_pins_v1_10
		#(.id("777816b9-07cf-470b-8409-32cebe881d45"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		ESTOP
		 (.oe(tmpOE__ESTOP_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ESTOP_net[0:0]}),
		  .io({tmpIO_0__ESTOP_net[0:0]}),
		  .siovref(tmpSIOVREF__ESTOP_net),
		  .interrupt({tmpINTERRUPT_0__ESTOP_net[0:0]}),
		  .annotation({Net_585}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__ESTOP_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    cy_annotation_universal_v1_0 COAST (
        .connect({
            Net_749,
            Net_746,
            Net_750,
    ...
    defparam COAST.comp_name = "Relay_v1_0";
    defparam COAST.port_names = "C1, C2, NC1, NC2, NO1, NO2, T1, T2";
    defparam COAST.width = 8;

    cy_annotation_universal_v1_0 NFET1 (
        .connect({
            Net_745,
            Net_656,
            Net_744
    ...
    defparam NFET1.comp_name = "NFET_v1_0";
    defparam NFET1.port_names = "D, G, S";
    defparam NFET1.width = 3;

    cy_annotation_universal_v1_0 NFET2 (
        .connect({
            Net_754,
            Net_752,
            Net_753
    ...
    defparam NFET2.comp_name = "NFET_v1_0";
    defparam NFET2.port_names = "D, G, S";
    defparam NFET2.width = 3;
    ...
    cy_annotation_universal_v1_0 REVERSE (
        .connect({
            Net_758,
            Net_755,
            Net_759,
    ...
    defparam REVERSE.comp_name = "Relay_v1_0";
    defparam REVERSE.port_names = "C1, C2, NC1, NC2, NO1, NO2, T1, T2";
    defparam REVERSE.width = 8;
    ...
    cy_annotation_universal_v1_0 ESTOP_EN (
        .connect({
            Net_585,
            Net_586
        })
    );
    defparam ESTOP_EN.comp_name = "SwitchSPST_v1_0";
    defparam ESTOP_EN.port_names = "T1, T2";
    defparam ESTOP_EN.width = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("8c681d3c-6891-4909-927e-3366ad4d5e0f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
