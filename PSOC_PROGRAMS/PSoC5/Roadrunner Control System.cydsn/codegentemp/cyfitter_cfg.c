...
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x48000898u)
...
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x480008B0u)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG1_CFG0), 0x0055u);
	CY_SET_XTND_REG8((void CYFAR *)(CYREG_CLKDIST_DCFG1_CFG0 + 0x2u), 0x18u);
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG2_CFG0), 0x013Du);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT0_AG, 0x8Au);
...
void cyfitter_cfg(void)
{
	...
	ClockSetup();
	/* Set Flash Cycles based on newly configured 26.50MHz Bus Clock. */
