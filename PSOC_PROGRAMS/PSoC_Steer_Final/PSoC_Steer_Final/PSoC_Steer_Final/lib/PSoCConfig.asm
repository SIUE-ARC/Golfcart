...
export LoadConfig_dac_prac
export _LoadConfig_dac_prac
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_dac_prac
	lcall	LoadConfigTBL_dac_prac_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration dac_prac
;
;    Load configuration registers for dac_prac.
...
_LoadConfig_dac_prac:
 LoadConfig_dac_prac:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_dac_prac_Bank0
    mov     X, <LoadConfigTBL_dac_prac_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_dac_prac_Bank1
    mov     X, <LoadConfigTBL_dac_prac_Bank1
